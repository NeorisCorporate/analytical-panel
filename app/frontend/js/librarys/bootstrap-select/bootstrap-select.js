...
(function ($) {
  ...
  Selectpicker.DEFAULTS = {
    ...
    maxOptionsText: function (numAll, numGroup) {
      return [
        (numAll == 1)   ? 'Limite atingindo de ({n} item no máximo)' : 'Limite atingindo de ({n} items no máximo)',
        (numGroup == 1) ? 'Limite de Grupo atigindo, de ({n} item no máximo)' : 'Limite de Grupo atigindo, de ({n} items no máximo)'
      ];
    },
